	...
	<body>
		...
		<div id="show-scene" class="content scaffold-show" role="main">
			...
			<ol class="property-list scene">
				...
				<g:if test="${sceneInstance?.address}">
				<li class="fieldcontain">
					<span id="address-label" class="property-label"><g:message code="scene.address.label" default="Address" /></span>
					
						<span class="property-value" aria-labelledby="address-label"><g:fieldValue bean="${sceneInstance}" field="address"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${sceneInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="scene.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${sceneInstance}" field="description"/></span>
